...
import { safeRenderHtml } from "@/utils/sanitize";
          ...
          <div className="space-y-2">
            ...
            >
              <div
                ...
                dangerouslySetInnerHTML={{ __html: safeRenderHtml(content) }}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              <div
                ...
                dangerouslySetInnerHTML={{ __html: safeRenderHtml(polishedContent) }}
              />
            </div>
          </div>
        </div>
