...
const BaseInfo = ({
  ...
  const PhotoComponent = basic.photo && basic.photoConfig?.visible && (
    <motion.div layout="position">
      <div
        style={{
          width: `${Math.min(basic.photoConfig?.width || 80, 120)}px`,
          height: `${Math.min(basic.photoConfig?.height || 80, 120)}px`,
      ...
      >
        <Image
          ...
          width={Math.min(basic.photoConfig?.width || 80, 120)}
          height={Math.min(basic.photoConfig?.height || 80, 120)}
