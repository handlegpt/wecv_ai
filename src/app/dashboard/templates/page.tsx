          ...
          {DEFAULT_TEMPLATES.map((template) => {
            ...
            return (
              <motion.div key={template.id} variants={item}>
                <Card
                  className={cn(
                    "group cursor-pointer overflow-hidden transition-all hover:shadow-md max-w-[400px] mx-auto",
                  ...
                  <CardContent className="p-0">
                    <div className="relative aspect-[210/297] w-full overflow-hidden bg-gray-50 dark:bg-gray-900">
                      ...
                      <div className="h-full w-full p-3 transition-all duration-300 group-hover:scale-[1.01]">
                        <div className="relative h-full w-full overflow-hidden rounded-lg shadow-sm bg-white">
